...
**
** Created: Mon Sep 9 19:18:35 2019
...
public:
    ...
    void setupUi(QWidget *Maincontrol)
    {
        ...
        Maincontrol->resize(1045, 635);
        label = new QLabel(Maincontrol);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(440, 130, 191, 81));
        QFont font;
