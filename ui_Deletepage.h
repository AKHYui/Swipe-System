...
public:
    ...
    void setupUi(QWidget *Deletepage)
    {
        ...
        ptn_release = new QPushButton(Deletepage);
        ptn_release->setObjectName(QString::fromUtf8("ptn_release"));
        ptn_release->setGeometry(QRect(30, 310, 321, 31));
        ptn_delete = new QPushButton(Deletepage);
        ptn_delete->setObjectName(QString::fromUtf8("ptn_delete"));
        ptn_delete->setGeometry(QRect(360, 310, 301, 31));
